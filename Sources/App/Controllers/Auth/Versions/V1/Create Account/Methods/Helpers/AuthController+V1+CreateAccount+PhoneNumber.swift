...
typealias CheckPhoneNumberAvailabilityResult = (availability: PhoneNumberAvailability.V1, attempt: SMSVerificationAttempt?)
...
extension AuthController.V1.CreateAccount {
    ...
    func checkPhoneNumberAvailability(
        ...
        clientID: UUID,
        _ req: Request
    ) async throws -> CheckPhoneNumberAvailabilityResult{
